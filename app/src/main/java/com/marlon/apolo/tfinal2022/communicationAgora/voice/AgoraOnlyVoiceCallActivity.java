package com.marlon.apolo.tfinal2022.communicationAgora.voice;
...
public class AgoraOnlyVoiceCallActivity extends AppCompatActivity {
    ...
    private static final String TAG = AgoraOnlyVoiceCallActivity.class.getSimpleName();
...
//                    Toast.makeText(AgoraOnlyVoiceCallActivity.this, "Estableciendo comunicación", Toast.LENGTH_SHORT).show();
                    stopPlaying();
                    ...
                    try {
                        ...
                        textViewRemoteUser.setText(usuarioRemoto.getNombre() + " " + usuarioRemoto.getApellido());
                    } catch (Exception e) {
...
//                        requestPermissions(new String[]{Manifest.permission.RECORD_AUDIO}, 8000);
                        ActivityCompat.requestPermissions(AgoraOnlyVoiceCallActivity.this, REQUESTED_PERMISSIONS, PERMISSION_REQ_ID);
...
//                        Toast.makeText(getApplicationContext(), "GG permisos", Toast.LENGTH_LONG).show();
//                        requestPermissions(new String[]{Manifest.permission.RECORD_AUDIO}, 8000);
                        if (ContextCompat.checkSelfPermission(AgoraOnlyVoiceCallActivity.this, REQUESTED_PERMISSIONS[0]) == PackageManager.PERMISSION_GRANTED) {
                            value = true;
                        } else {
                            AlertDialog.Builder builder = new AlertDialog.Builder(AgoraOnlyVoiceCallActivity.this);
//        builder.setTitle("");
                            ...
                            builder.setNegativeButton("Cancelar", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    Toast.makeText(AgoraOnlyVoiceCallActivity.this, "Permiso de audio NO concedido!", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                            });
...
//        Log.d(TAG, "setupVideoConfig");
    ...
    private void fetchToken(int uid, String channelName, int tokenRole) {
        ...
        switch (externalServer) {
            case "Java":
                AgoraTokenAsyncTaskWithJava agoraTokenAsyncTaskWithJava = new AgoraTokenAsyncTaskWithJava(AgoraOnlyVoiceCallActivity.this,
                        isJoined,
                        agoraEngine,
                        channelName,
                        uid);
                ...
                break;
            case "Node.js":
                AgoraTokenAsyncTaskWithNodeJs agoraTokenAsyncTaskWithNodeJs = new AgoraTokenAsyncTaskWithNodeJs(AgoraOnlyVoiceCallActivity.this,
                        isJoined,
                        agoraEngine,
                        channelName,
                        uid);
...
//            localSurfaceView.setVisibility(View.VISIBLE);
            ...
            showMessage("Permiso de micrófono NO concedido!");
        }
    }
        ...
        switch (view.getId()) {
            case R.id.radio_java:
                if (checked) {
                    ...
                    Toast.makeText(AgoraOnlyVoiceCallActivity.this,
...
//        mediaPlayerCallTone = MediaPlayer.create(contextInstance, R.raw.beat_it_gameboy);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hideSystemBars();
        setContentView(R.layout.activity_agora_only_voice_call);
    ...
    private void setListenerLlamadaRemota(LlamadaVoz llamadaVideoRemota) {
        ...
        childEventListenerResponder = new ChildEventListener() {
            ...
            public void onChildChanged(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                if (llamadaVideoChanged.getId().equals(llamadaVideoRemota.getId())) {
