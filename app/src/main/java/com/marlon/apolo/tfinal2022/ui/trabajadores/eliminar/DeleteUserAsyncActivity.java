...
public class DeleteUserAsyncActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete_user_async);
    ...
    public void searchBooks(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()
            ...
            new DeleteUserAsyncTask(mTitleText, mAuthorText).execute(queryString);
            mAuthorText.setText("");
