...
public class SpecialOficio2ListAdapter extends RecyclerView.Adapter<SpecialOficio2ListAdapter.OficioViewHolder> {

    private static final String TAG = SpecialOficio2ListAdapter.class.getSimpleName();
    private final Context context;
    private final LayoutInflater inflater;
    private List<Oficio> oficios;

    public SpecialOficio2ListAdapter(Context context) {
    ...
    public OficioViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SpecialOficio2ListAdapter.OficioViewHolder(itemView);
    }
...
//            }
        ...
        final SpecialHabilidad2ListAdapter adapter = new SpecialHabilidad2ListAdapter(context);
...
//        }
    ...
    public void addOficio(Oficio oficioVar) {
        oficios.add(oficioVar);
        notifyItemChanged(oficios.size() - 1);
    }
