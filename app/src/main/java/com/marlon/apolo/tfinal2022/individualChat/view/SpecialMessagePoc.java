...
public class SpecialMessagePoc extends RecyclerView.Adapter<SpecialMessagePoc.MyadapterViewHolder> {
    ...
    private static final String TAG = SpecialMessagePoc.class.getSimpleName();
    ...
    public SpecialMessagePoc(Activity activity) {
