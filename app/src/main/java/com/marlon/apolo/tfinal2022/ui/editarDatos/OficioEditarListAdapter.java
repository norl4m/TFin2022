...
public class OficioEditarListAdapter extends RecyclerView.Adapter<OficioEditarListAdapter.OficioViewHolder> {

    private final Context context;
    private final LayoutInflater inflater;
    private List<Oficio> oficios;

    public OficioEditarListAdapter(Context context) {
    ...
    public OficioViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new OficioEditarListAdapter.OficioViewHolder(itemView);
    }
