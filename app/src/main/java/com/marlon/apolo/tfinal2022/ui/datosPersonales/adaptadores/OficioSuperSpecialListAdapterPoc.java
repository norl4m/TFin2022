...
public class OficioSuperSpecialListAdapterPoc extends
        RecyclerView.Adapter<OficioSuperSpecialListAdapterPoc.OSuperListAdapteWordViewHolder> {
    ...
    public class OSuperListAdapteWordViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        final OficioSuperSpecialListAdapterPoc mAdapter;
         ...
         */
        public OSuperListAdapteWordViewHolder(View itemView, OficioSuperSpecialListAdapterPoc adapter) {
            super(itemView);
...
//            itemView.setOnClickListener(this);
    ...
    public OficioSuperSpecialListAdapterPoc(Context context, ArrayList<Oficio> wordList) {
        mInflater = LayoutInflater.from(context);
        this.oficioArrayList = wordList;
    }

    public OficioSuperSpecialListAdapterPoc(Context context) {
